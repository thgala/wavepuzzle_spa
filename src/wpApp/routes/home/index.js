...
export default class CheckoutHome extends Component {
  ...
  render() {
    return (
      <WP_Layout.components.screenSection center>
        <WP_Layout.components.logo sq={120} />
        <WP_Layout.components.container>
      ...
      </WP_Layout.components.screenSection>
    );
  }
}
          ...
          //   video
          //   dark
          //   image={`http://galaxiesanddust.de/images/06/sun_by_galaxiesanddust.png`}
